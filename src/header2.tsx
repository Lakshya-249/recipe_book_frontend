...
function Header2() {
  ...
  return (
    <div className="sticky top-0 z-30">
      <div className="max-sm:flex bg-black items-center mb-[1.5px] justify-between hidden w-full max-sm:px-3.5 h-[5.6rem]">
        ...
        <div
          ref={ref1}
          className="absolute hidden shadow-2xl bg-white z-30 text-left top-[5.5rem] left-0 text-sm font-semibold font-[Mona sans]
